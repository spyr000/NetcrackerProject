...
public class DTVContractValidatorTest {
    private Contract okDigitalTelevisionContract;
    private Contract errorDigitalTelevisionContract;
    private Contract redriskDigitalTelevisionContract;
    ...
    public void testContractGetByID() {
        ...
        Assert.assertEquals(okStatus,ValidationStatus.OK);
        Assert.assertEquals(errorStatus,ValidationStatus.Error);
